...
// SD Card
#define SD_CS  41
#define SD_DI  40 // MOSI
#define SD_CLK 39
#define SD_DO  38 // MISO

// Touch panel PIO
//#define TP_INT 7 // Touch interrupt
//#define TP_SDA 6 // Touch IIC data
//#define TP_SCL 5 // Touch IIC clock
//#define TP_RST 4 // Touch reset, multiplexed with LCD reset
