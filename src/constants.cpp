...
// Color map array of 256 colors from cold to hot
...
// Root web page HTML code
const char rootPageHtml[] = R"rawliteral(
<html>
  <head>
    ...
    <style>
      body {
        ...
        background: linear-gradient(to bottom, #b8d8e0, #5fa7b9);
        text-align: center;
        padding: 2px;
      }
      h1, h2, h3 { 
      ...
      @media (max-width: 600px) {
        body { padding: 8px; }
        .file-container { margin: 5px; }
        img { max-width: 50px; }
      }
    </style>
  </head>
  <body>
    <h3>MLX90640 camera</h3>
    %CONTENT%
    %PAGINATION%
  </body>
</html>
...
const char imagePageHtml[] = R"rawliteral(
<html>
  <head>
  ...
  <body>
    <img src='%IMAGE_SRC%' alt='Enlarged Image'>
  </body>
</html>
)rawliteral";